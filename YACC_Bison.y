...
%token <sval> DIRECTIVE STRING KEYWORD IDENTIFIER SEPARATOR CHARACTER CONSTANT ASSIGNMENT OP OP_2 INCREMENT DECREMENT BOOLEAN_OP COMPARISON SEPARATOR_2 CONTINUE_BREAK FUNCTION WRITE_READ_COMMAND
...
RETURN : KEYWORD VALUE SEPARATOR
